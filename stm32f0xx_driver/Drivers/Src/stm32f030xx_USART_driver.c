...
void USART_SetBaudRate(USART_RegDef_t *pUSARTx, uint32_t BaudRate)
{
  ...
  if(pUSARTx == USART1 ||  pUSARTx == USART2 || pUSARTx == USART3 || pUSARTx == USART4)
  {
	   //USART1 and USART6 are hanging on APB2 bus
	   PCLK = RCC_GetPCLKValue();
  }
  ...
  if(pUSARTx->CR1 & ( 1 << USART_CR1_OVER8))
   {
	  //OVER8 = 1 , over sampling by 8
	  F_part = ((( F_part * 8)+ 50) / 100)& ((uint8_t)0x07)>>1;
...
/*************************Check for TC flag ********************************************/
	...
	temp1 = pUSARTHandle->pUSARTx->ISR & ( 1 << USART_SR_TC);
	...
	if(temp1 && temp2 )
	{
		...
		if ( pUSARTHandle->TxBusyState == USART_BUSY_IN_TX)
		{
			...
			if(! pUSARTHandle->TxLen )
			{
				...
				pUSARTHandle->pUSARTx->ISR &= ~( 1 << USART_SR_TC);
...
/*************************Check for TXE flag ********************************************/
	...
	temp1 = pUSARTHandle->pUSARTx->ISR & ( 1 << USART_SR_TXE);
...
/*************************Check for RXNE flag ********************************************/
	...
	temp1 = pUSARTHandle->pUSARTx->ISR & ( 1 << USART_SR_RXNE);
...
//Note : CTS feature is not applicable for UART4 and UART5
	...
	temp1 = pUSARTHandle->pUSARTx->ISR & ( 1 << USART_SR_CTS);
	...
	if(temp1  && temp2 )
	{
		...
		pUSARTHandle->pUSARTx->ISR &=  ~( 1 << USART_SR_CTS);
...
/*************************Check for IDLE detection flag ********************************************/
	...
	temp1 = pUSARTHandle->pUSARTx->ISR & ( 1 << USART_SR_IDLE);
...
/*************************Check for Overrun detection flag ********************************************/
	...
	temp1 = pUSARTHandle->pUSARTx->ISR & USART_SR_ORE;
